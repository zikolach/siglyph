# unicode-text Specification

## Purpose
Defines Unicode 17.0.0 UAX #29 default extended grapheme segmentation, whole-string and incremental equivalence, bounded state, and deterministic shared data.
## Requirements
