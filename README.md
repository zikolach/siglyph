...
The Scala CLI examples in this branch reference local `0.2.6-SNAPSHOT` artifacts. Run `./scripts/publish-local-snapshot.sh` from the repository root before running them.
